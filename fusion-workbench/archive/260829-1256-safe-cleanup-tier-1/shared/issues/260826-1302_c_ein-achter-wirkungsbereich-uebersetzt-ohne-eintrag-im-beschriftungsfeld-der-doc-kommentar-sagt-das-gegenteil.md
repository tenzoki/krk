...
Abgleich 260828-1044: bestätigt gegen `2aee690` — `ACHT_BESCHRIFTUNGEN` (`crates/krk-core/tests/belegung.rs:1977`), Varianten aus `varianten_der_aufzaehlung` (`:2033`); `Wirkungsbereich` trägt acht Werte (`crates/krk-core/src/tasten/belegung.rs`). Bleibt `_c_`.
