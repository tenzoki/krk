...
Promoted: circles/260828-1041-dateilistenfilter-nimmt-eingaben-per-paste — als zweite Fähigkeit in den Spec `planning/260829-1052_*_spec-einfuegen-in-den-filter-und-stern-als-platzhalter.md` aufgenommen (C5 bis C7, Festlegungen B1 bis B9); der Filter der Dateiliste versteht `*` als Platzhalter für eine beliebige Zeichenfolge, im ganzen Filtertext.
