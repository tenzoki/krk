...
---
Implemented: e49412a — 145 Zitate in 21 Werkbankdateien und 18 unter `crates/` und in `CLAUDE.md` auf die Sternform gebracht, insgesamt 163. Zwei Zeilen stehen weiter mit ausgeschriebenem Buchstaben da, weil der Marker dort die Aussage ist und kein Zeiger: beide sind Sätze über Zitate (`circles/260807-2116-eingebauter-editor-mit-textmarken/planning/260808-0140_*_plan-eingebauter-editor-mit-textmarken.md:1670` und `circles/260813-0100-suche-in-der-belegung-vollstaendiges-menue-weitere-instanz/planning/260813-0205_*_plan-suche-in-der-belegung-vollstaendiges-menue-weitere-instanz.md:625`). Die eingefrorenen Orte sind nach der Ortsregel unangetastet geblieben.

**Der Beleg, den die Umstellung nebenbei geliefert hat:** von 111 verschiedenen Zitaten im lebenden Text der Werkbank trugen 52 einen Marker, den ihr Ziel nicht mehr hat — 47 Prozent, quer durch alle zehn Runden und weit vor dieser Sitzung. Kein einziges Ziel war unauffindbar; es war ausschließlich der Marker, der veraltete. Genau die Menge, gegen die die Sternform hilft.

**Und der Gegenbeleg zur Sorge, die Umstellung kehre eine Gewohnheit um:** der Baum schrieb schon vorher über 350-mal die Sternform gegen 17 ausgeschriebene Marker unter `crates/`. Der Plan der Runde 2 hält an seiner Zeile 1670 sogar ausdrücklich fest, dass 39 seiner 40 Verweise die Sternstelle tragen. Die Entscheidung kodifiziert die Mehrheitsform.
