...
---
Resolved: Ohne Änderung geschlossen, weil die Voraussetzung des Befunds weggefallen ist.

Dieser Datensatz begründet das Nachziehen ausdrücklich damit, dass der L7-Entscheid **offen**
ist und gelesen wird, um beantwortet zu werden: „Deshalb ist die Zahl nachzuziehen und nicht
als Aufzeichnung eines damaligen Standes stehen zu lassen." Genau das trifft nicht mehr zu.
`260824-1900_i_wie-wird-die-arbeit-dieser-runde-jemals-gegen-l7-gemessen-die-messstrecke-sieht-sie-nicht.md`
trägt seit dem 260907 den Marker `_i_`: der Nutzer hat am 260907-1355 die Möglichkeit 2
gewählt, und die Messstrecke hat den Ordnersprung seit dem 260907-1422.

Damit ist der Satz im Frageteil kein Entscheidungsgrundlagentext mehr, sondern die
Aufzeichnung eines damaligen Standes, und für die gilt die Ortsregel: Datensätze unter
`decisions/` behalten ihren damaligen Stand. Niemand wählt mehr auf dieser Grundlage.

Die gemessenen Zahlen dieses Datensatzes bleiben richtig und stehen nachlesbar in
`shared/analyses/260825-2107-was-die-zwoelf-leseprofile-an-der-wirklichen-werkbank-kosten.md`,
Abschnitt „Die vier Zahlen je Profil".
