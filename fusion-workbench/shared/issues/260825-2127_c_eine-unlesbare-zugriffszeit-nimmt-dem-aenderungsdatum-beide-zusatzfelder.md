...
---
Resolved: `zeit_uebernehmen` (`crates/krk-core/src/operation/zippen.rs`) haengt die zwei
Zusatzfelder nur noch am Aenderungsdatum; die Zugriffszeit faellt auf das Aenderungsdatum
zurueck, wenn sie fehlt **oder** ausserhalb der vier Byte liegt. Der Kommentar nennt beide
Lagen und den Grund, warum sie gleich behandelt sind. Gehalten von der neuen Probe
`eine_zugriffszeit_vor_1970_laesst_dem_aenderungsdatum_beide_zusatzfelder`
(`crates/krk-core/tests/operation.rs`), die eine Zugriffszeit von 1969 setzt und beide
Kennungen samt Epochensekunde des Aenderungsdatums einfordert.
