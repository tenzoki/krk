...
---
Resolved: `Editorbereich::umbruch_setzen` ruft `setSize:` statt `setContainerSize:`; die Bedeutung ist dieselbe. Der Untergrenzen-Abschnitt von `editor.rs` fuehrt `NSTextContainer.size` jetzt als siebte Methode, die juenger ist als ihre Klasse (macOS 10.11), und nennt die weiche Abkuendigung des alten Namens samt Fundstelle im Kopf des Systems.
