...
10. [DONE] **Was die acht Profile an der wirklichen Werkbank kosten**
    - Executor: `analyst`
    ...
    - **Nachtrag 260825-2107, Erhebung. Gemessen sind zwölf Profile und nicht acht**, nach dem Nachtrag zu Schritt 8. Der Bericht steht in `shared/analyses/260825-2107-was-die-zwoelf-leseprofile-an-der-wirklichen-werkbank-kosten.md`. Die vier Zahlen je Profil stammen aus zwei Quellen: Leseläufe und Dateiöffnungen aus `zusammenfassen_gezaehlt`, geöffnete Verzeichnisse und gelesene Einträge aus einer Zählung von `open(2)`, `getattrlistbulk(2)` und `realpath(3)` über eine abfangende Bibliothek im Wegwerfverzeichnis der Sitzung; der KRK-Baum trägt keine Zeile Prüfcode dieser Messung. **Die Abweichung, um die es dem Schritt ging, ist bestätigt:** das Profil `circles/` kostet drei Leseläufe und **neununddreißig** Verzeichnisöffnungen. Die Rechnung dieses Abschnitts trifft bei `circles/` und `archive/` Stelle für Stelle, bei `shared/` in Läufen und Öffnungen (die Einträge sind 286 und nicht ~264), und bei der Projektwurzel liegt sie in allen drei Spalten um eins zu hoch (gemessen 4 / 4 / 4). Die Rechnung des Datensatzes `shared/issues/260825-1953_o_…` ist an künstlichen Bäumen nachgemessen und **bestätigt**: 22.001 Verzeichnisöffnungen bei elf Sammlungen, 4.001 beim ausgelieferten Profil über 2.500 leere Runden. Abgelegt sind zwei Defektdatensätze vom 260825-2107, einer zur überholten Zahl im L7-Entscheid und einer zu einem Circle-Datensatz beim 1,8-fachen der 64-KB-Grenze.
