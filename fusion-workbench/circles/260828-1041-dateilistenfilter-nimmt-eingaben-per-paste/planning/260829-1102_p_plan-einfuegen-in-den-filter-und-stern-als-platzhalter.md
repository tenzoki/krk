...
1. **Der eine Vergleich wird zum Musterabgleich, und das Muster reist als Typ**
   - Executor: `coder`
...
3. **Die Zulässigkeitsregel sagt, wen ihr zweiter Eingang bedient**
   - Executor: `coder`
...
4. **Die zwei Kommentare der Belegungsdatei**
   - Executor: `ontocoder`
...
5. **Die vier Sätze der Statuszeile**
   - Executor: `coder`
...
8. **Die dritte Antwort beim Anwendungsdelegierten**
   - Executor: `coder`
...
9. **Die Proben des Kerns am Ordnermodell, am Durchlauf und am Inhalt, und die Zählprobe zieht nach**
   - Executor: `coder`
...
10. **Die Prosa des Menüs und des Kommandoverzeichnisses, und zwei Randproben**
    - Executor: `coder`
