...
- Turn 2 (Sitzung 260814-1500): Commits 14db98d..3af3f4a, vier Stueck. Ein Reparatur-Turn ohne Planschritte. Der hohe Befund der Durchsicht ist an der Wurzel behoben: der Durchlauf hielt einen offenen Deskriptor je Ebene, erzeugte damit den Mangel selbst und legte ihn als "kein Treffer darunter" aus; er haelt jetzt genau einen, gleich wie tief der Baum ist. Vier Proben, die mehr zusagten als sie hielten, sind nachgezogen, darunter eine, die auch bei einem voellig kaputten Durchlauf bestanden haette. Fuenf Spec-Stellen sind dem Baum nachgezogen, das zweite Bild neu gezeichnet (22 Knoten, 31 Kanten, fuenf Kreise), und C3.15 ist mit Gegenprobe ganz gemessen. Abnahmekriterien: 77 statt 75, die zehn mit Buendelanteil unveraendert. Coherence-Urteil: noch nicht gefahren. Sitzungsprotokoll: shared/history/260814-1500-orchestrator-session.md

## Closure note

**Beschraenkter Abschluss am 260815.** Alle vierzehn Planschritte sind gebaut, alle sechs Faehigkeiten stehen im Baum, zwei Turns und 23 Commits, `make check` nach jedem Schritt gruen. Die Runde ist trotzdem nicht abgenommen, und der Grund ist derselbe wie bei acht Runden davor und keine Haeufung von Fehlschlaegen: **der Abnahmelauf verlangt KRK im Vordergrund und ist damit Nutzerarbeit.** Der Nutzer hat am 260815 gewaehlt, beschraenkt zu schliessen statt vorher abzunehmen.

**Was der Artefakt traegt.** Tippen im Dateifenster filtert die Liste auf Namen, die die getippte Zeichenfolge an beliebiger Stelle tragen, ohne Ruecksicht auf Gross- und Kleinschreibung. Der Filtertext gehoert dem Tab und ueberlebt einen Tabwechsel; `Esc` raeumt ihn als dritten und letzten Rang weg, hinter einem stehenden Blatt und einer laufenden Operation. Die Ruecktaste nimmt bei stehendem Filtertext ein Zeichen zurueck und erreicht `in_papierkorb` dabei nicht; eine Tastenwiederholung traegt nicht ueber die Grenze. Ein neuntes Ankreuzfeld "Deep" neben "Typ" weitet den Filter auf den Unterbaum aus: ein Ordner bleibt sichtbar, solange unter ihm ein Treffer liegt, und der Nutzer navigiert gewoehnlich hinein. Die eine Statuszeile bekommt einen sechsten Rang, der Filtertext, gezeigte gegen vorhandene Eintraege und die ausgeblendeten Markierungen nennt.

**Ein abgenommenes Kriterium der Runde 1 ist ersetzt und nicht ergaenzt.** Die Sprungmarke ist gefallen; das sechste Abnahmekriterium von C2 der Runde 1 lautet nach dieser Runde anders. Was der Nutzer verliert, steht im Spec benannt und ist von ihm ausdruecklich so gewaehlt worden: der Sprung ist auf keinem Weg mehr zu haben, die Auswahl bleibt stehen wo sie stand, und der Bestand ist nach dem Tippen erst mit `Esc` wieder vollstaendig zu sehen.

**Was diese Runde ueber sich selbst gelernt hat, und das ist der uebertragbare Teil.** Der Fehlertyp, den die Runde 7 dreimal gefunden hat, ist hier siebenmal aufgetreten und jedes Mal von einer Pruefung gefangen worden, nie von einem Menschen beim Lesen: **ein Text sagt mehr zu, als seine Probe haelt.** Zwei Diagrammpruefungen des Spec fanden je einen echten Fehler, bevor eine Zeile Code geschrieben war — einen fehlenden Ausgang im Durchlauf, den drei Abnahmekriterien voraussetzen, und zwei Widersprueche zwischen Abnahmekriterien. Die Durchsicht fand einen hohen Befund, den sie nachgestellt statt erschlossen hat. Und eine Zaehlprobe aus A2 fing waehrend F2 einen dritten Rufer des einen Vergleichs; nicht die Zahl in der Probe wurde erhoeht, sondern die Wurzel behoben.

**Zweimal ist eine Ursache behoben worden statt eines Symptoms**, und beide Male war die Wurzelbehebung billiger als der Sonderfall. Der Durchlauf lief fuer jeden Ordner, auch fuer einen, den sein Name schon entschieden hatte; jetzt traegt die Eintrittskante die Bedingung selbst, und der Widerspruch ist nicht behandelt, sondern unmoeglich. Und der Durchlauf hielt einen offenen Deskriptor je Ebene, erzeugte damit den Mangel, den er als "kein Treffer darunter" auslegte; jetzt haelt er genau einen, gleich wie tief der Baum ist.

**Was aussteht.** Die Abnahmeliste `history/260815-0400-abnahmeliste-g2.md`, geschaetzt 25 Minuten am laufenden Buendel, mit zehn der 77 Kriterien im Buendelanteil und vier sicherheitsrelevanten darunter. Acht Defektdatensaetze und fuenf Fragen bleiben offen; keiner der acht betrifft das Verhalten des Filters im gewoehnlichen Gebrauch, der Schwerpunkt liegt bei Proben ohne Ort und bei Prosa, die dem Code hinterherlaeuft. Der Marker bewegt sich davon nicht mehr: beschraenkt ist ein Endzustand, und eine Fortsetzung waere ein neuer Circle, der diesen ueber `## Dependencies` zitiert.
