...
- [ ] C5.4 **Defektspeicher.** Für `shared/issues` und `circles/<name>/issues` erscheinen die Zahl der offenen, die Zahl der geschlossenen und die zehn jüngsten Titel. Für `shared/issues` sind es 54 offene von 82. *(Am 260824-1751 berichtigt; die Berichtigung steht unter dieser Liste.)*
