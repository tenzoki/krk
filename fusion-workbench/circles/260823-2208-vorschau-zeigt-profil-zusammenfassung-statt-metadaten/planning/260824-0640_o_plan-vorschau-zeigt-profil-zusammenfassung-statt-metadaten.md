...
6. **Die vier Bausteine, der Haushalt und die Regel über die Teillesung**
   - Executor: `coder`
   - Files: `crates/krk-core/src/leseprofil/bausteine.rs`, `crates/krk-core/src/leseprofil/mod.rs`
