...
1. **Die Ausdruckskiste kommt in den Arbeitsbereich, und ihr Preis wird gemessen**
   - Executor: `coder`
...
2. **`readers.toml` wird die siebte Ablagedatei**
   - Executor: `coder`
...
3. **Die Gestalt der Datei und der Prüfschritt dahinter**
   - Executor: `coder`
   - Files: `crates/krk-core/src/leseprofil/mod.rs`, `crates/krk-core/src/leseprofil/datei.rs`, `crates/krk-core/src/lib.rs`
...
4. **Zwei Lesewege bekommen ihren Deckel, und keiner kommt hinzu**
   - Executor: `coder`
   - Files: `crates/krk-core/src/verzeichnis/leser.rs`, `crates/krk-core/src/text/datei.rs`
...
5. **Die Erkennung, in zwei Durchgängen und ohne dritten**
   - Executor: `coder`
   - Files: `crates/krk-core/src/leseprofil/erkennung.rs`
