...
6. **Die eine Hülle liest die Ablage eines Ziehvorgangs**
   - Executor: `coder`
...
7. **Die reine Regel: Marke, Schreibrecht, Urteil**
   - Executor: `coder`
...
8. **Was AppKit über einen Ziehvorgang und einen Ordner sagt**
   - Executor: `coder`
...
9. **Die Frage nach dem laufenden Vorgang verliert ihre Nebenwirkung, und die Maschine bekommt ihren dritten Eingang**
   - Executor: `coder`
   - Files: `crates/krk-ui/src/appkit/anwendung.rs`
