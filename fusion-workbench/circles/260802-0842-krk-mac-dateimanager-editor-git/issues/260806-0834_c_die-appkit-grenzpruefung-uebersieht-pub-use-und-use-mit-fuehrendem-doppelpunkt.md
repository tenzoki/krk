...
---
Resolved: ist_objc2_use in xtask/src/release.rs liest Sichtbarkeitspräfix (pub use) und führendes :: mit. Offen bleibt die Planpflege: das Abnahmekriterium von S23 nennt weiter das alte Grep, nachgezogen mit dem Doku-Bündel dieses Turns.
