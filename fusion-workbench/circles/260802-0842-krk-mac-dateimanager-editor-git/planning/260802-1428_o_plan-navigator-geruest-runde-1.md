...
**Der Vermerk dieses Schrittes bleibt ohne `[DONE]`, bis diese Messung vorliegt.** Erst dann ist das Abnahmekriterium in beiden Teilen erfüllt, und erst der Commit dazu zieht `decisions/260803-1755_a_l1-verfehlt-die-16-ms-zusage-am-bildrand.md` auf "umgesetzt". S21 erbt dieselbe Auswertung und misst L9 auf demselben Weg; ein zweites Verfahren entsteht dort nicht.
...
Sieben Punkte sind beim Planen und beim Nachziehen aufgefallen und liegen als eigene Dateien, nicht in diesem Plan vergraben. Neun weitere kamen aus den Umsetzungen zurück, sechs aus den Schritten 2 bis 5 und drei aus Schritt 8. Vier davon sind mit dem Nachzug vom 260802-1859 geschlossen, zwei mit dem vom 260803-1200 und zwei mit dem vom 260803-1819:
...
- `decisions/260803-1755_a_l1-verfehlt-die-16-ms-zusage-am-bildrand.md` — **beantwortet am 260803-1810.** Die Frühmessung aus S8 zeigte, dass L1 seine 16 ms nur in zehn von achtzehn Runden hält, ohne dass sich am Programm etwas ändert. Der Nutzer hat Möglichkeit 2 gewählt: L1 und L9 nehmen über den Anteil der Eingaben ab, die ihr nächstes Bild erreichen, und nicht mehr über das 95. Perzentil der Spanne. Möglichkeit 4, den Technologieentscheid aufzumachen, hat er abgelehnt. Im Spec berührt die Antwort C8 an vier Stellen, im Plan `### Frage 5`, S8 und S21. Der Datensatz kommt auf "umgesetzt", sobald die Auswertung in `crates/krk-bench/src/messen.rs` umgestellt ist und eine Messung gegen das neue Maß vorliegt.
