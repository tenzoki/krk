...
**Datum:** 2026-08-02, überarbeitet 260802-1735, 260803-1819, 260803-2300, 260804-0830, 260804-1122 und 260804-1832
**Status:** Entwurf. Alle Nutzerantworten bis 260804-1832 sind eingearbeitet. Eine offene Nutzerfrage trägt dieser Spec nicht mehr.
...
- [ ] Dieselbe Zeile trägt den Fortschritt einer laufenden Dateioperation aus C4. Wollen mehrere Quellen zugleich in die Zeile schreiben, gilt eine feste Rangfolge: der Fortschritt einer laufenden Operation steht über einer Meldung, die das ganze Fenster betrifft, und diese steht über einer Meldung zum Ordner des sichtbaren Tabs. Keine der drei Meldungen geht dabei verloren; eine verdrängte erscheint, sobald die vorrangige endet.
...
- [ ] Ein Tastenbefehl steigt in den ausgewählten Ordner ein, ein zweiter in den übergeordneten Ordner. Beim Aufstieg steht die Auswahl auf dem Ordner, aus dem der Nutzer gerade kam. Ab Werk liegt der Einstieg auf Cmd+Rechts und der Aufstieg auf Cmd+Links und Cmd+Auf.
- [ ] Ein Tastenbefehl wirkt dann und nur dann, wenn der Eingabefokus in einem Dateifenster oder in der Lesezeichenleiste steht. In der Pfadeingabe, im Umbenennen-Feld und in jedem anderen Textfeld behalten alle Tasten ihre gewohnte Mac-Bedeutung: Return bestätigt, Cmd+Links und Cmd+Rechts bewegen die Schreibmarke an Zeilenanfang und Zeilenende.
...
- **Der Auf- und Abstieg liegt auf den Links- und Rechts-Pfeilen, und Return ist ab Werk frei.** Der Nutzer hat das am 260804-1122 so bestimmt. Der Aufstieg trägt zwei Wege, Cmd+Links und Cmd+Auf, wie es die Norton-Reihe kennt; die Ein-Zeilen-Regel aus C3 führt beide in derselben Zeile der Belegungsansicht. Der Einstieg trägt nur Cmd+Rechts. Return war bis dahin der Einstieg, ist gebaut und geprüft, und der Nutzer hat die Umbelegung gegen den Hinweis gewählt, dass Return in Dateimanagern die vertrauteste Taste dafür ist. Frei heißt: KRK liefert für Return keine Vorbelegung aus und der Nutzer kann sie wie jede andere Taste selbst vergeben.
- **Eine freie Taste ohne Zusatztaste fällt im Dateifenster auf die Sprungmarke durch, und die nimmt nur druckbare Zeichen auf.** Das Tippen der Anfangsbuchstaben ist der Rückfall für jede Taste ohne Zusatztaste, die keiner Funktion zugeordnet ist. Return trägt kein Zeichen, das ein Dateiname tragen kann, und läuft deshalb ins Leere, ohne die begonnene Eingabe zu stören. Dieselbe Regel deckt jede unbelegte Funktionstaste ab; sie ist keine Sonderregel für Return.
...
- [ ] Seit dem 260804-1122 gilt für die Ordnernavigation aus C2: der Einstieg in einen Ordner liegt ab Werk auf Cmd+Rechts, der Aufstieg auf Cmd+Links und Cmd+Auf. Beide Wege des Aufstiegs stehen in derselben Zeile der Belegungsansicht.
- [ ] Die Return-Taste ist ab Werk unbelegt, so wie Shift+Delete, Cmd+C und Cmd+V. Der Nutzer kann sie frei belegen, KRK liefert sie nicht vorbelegt aus.
...
- Die vollständige Auslieferungsbelegung steht als Datendatei unter `resources/default-keymap.toml` und nicht in diesem Spec. Der Spec legt dreizehn ihrer 50 Belegungen selbst fest: die sechs Zeilen der Kürzel-Tabelle oben, F4 als unbelegt, die drei Kombinationen vom 260804-0830 und die drei vom 260804-1122, alle in den Kriterien darüber. Die übrigen 39 hat der `ontocoder` beim Schreiben der Datei gewählt; der Nutzer hat sie am 260803-2110 durchgesehen und für diese Runde angenommen. Was genau angenommen wurde, mit welcher Begründung und mit welcher Reichweite, steht in `decisions/260803-2300_i_auslieferungsbelegung-der-39-frei-gewaehlten-kombinationen.md`. Jener Datensatz ist umgesetzt und damit endgültig; er beschreibt den Stand von 46 Funktionen mit 52 Kombinationen, den der Nutzer angesehen hat. Die drei Einträge vom 260804-0830 und die drei Belegungen vom 260804-1122 fallen nicht unter seine Annahme, sondern unter diesen Spec. Zwei der letzten drei ändern eine Belegung, die der Nutzer damals angenommen hatte, den Aufstieg auf Cmd+Auf und den Einstieg auf Return; beide hat er am 260804-1122 selbst neu bestimmt, und die Annahme galt ausdrücklich für diese Runde und nicht auf Dauer. Die Zahlen hier ein zweites Mal aufzuführen hieße, die Datendatei im Spec zu verdoppeln; verbindlich ist die Datei.
...
- **Die drei Belegungen vom 260804-1122 folgen jede einem Vorbild, und alle drei sind gegen den Bestand geprüft.** Cmd+Links und Cmd+Rechts sind die Richtung, in der die Ordner nebeneinanderliegen; ForkLift und die Norton-Reihe legen den Auf- und Abstieg dorthin. Cmd+Auf bleibt daneben stehen, weil der Finder den Aufstieg dort führt und die Belegung ihn seit dem 260803 trägt. F1 trägt in der Norton-Reihe die Hilfe, und für eine Anwendung, deren erste Maxime die Tastatursteuerung ist, ist die Belegungsansicht genau das. Auf dem Mac ist F1 keine Hilfetaste, sondern die Verringerung der Bildschirmhelligkeit; das Vorbild ist hier also Norton und nicht der Mac, anders als bei den sechs Cmd-Kürzeln der Tabelle oben. Geprüft am 260804-1122 gegen alle 55 ausgelieferten Kombinationen: Cmd+Links, Cmd+Rechts und F1 kommen dort in keiner Tastenliste vor, und die Datei führt keine Kombination doppelt. Auf der Menüseite belegt sind Cmd+W und Shift+Cmd+W; keine der drei berührt sie.
- **Die Belegungsansicht steht damit innerhalb der Konflikterkennung, und ein Menükürzel bekommt sie nicht.** Der Mac-übliche Ort für eine solche Ansicht ist der Einstellungen-Eintrag im Anwendungsmenü mit Cmd+Komma. Menükürzel liegen außerhalb der Konflikterkennung, die dieser Abschnitt zusagt, und das Vorhaben führt mit dem Menüeintrag "Fenster schließen" bereits einen solchen Fall als offenen Defekt. Ein zweiter entstünde ohne Gegenwert: F1 erreicht die Ansicht, und diese Belegung sieht die Konflikterkennung.
...
- [ ] Eine Operation über mehr als 100 Einträge oder mehr als 100 MB zeigt einen Fortschritt und lässt sich mit einem Tastenbefehl abbrechen. Nach einem Abbruch nennt KRK, wie viele Einträge bereits übertragen wurden. Der Fortschritt steht in der Statuszeile aus C1, und zwar in der des Dateifensters, das die Operation begonnen hat, nicht in der des gerade aktiven. Die Zeile nennt den Tastenbefehl für den Abbruch, damit er ohne Schaltfläche zu finden ist.
...
**Am 260804-1122 hat der Nutzer die Ordnernavigation neu belegt, und daraus ist eine Folgefrage entstanden, die nichts bindet.** Die drei Belegungen selbst stehen in C2 und C3. Weil die Kombinationsschreibweise dabei um die Links- und Rechts-Pfeile wächst, entfällt der Grund, aus dem die Bereichsbreiten aus C7 auf den Behelfsbelegungen Ctrl+B und Ctrl+S liegen. Ob sie auf Ctrl+Links und Ctrl+Rechts wandern, ist eine Frage an den Nutzer, weil beide zu den 39 Kombinationen gehören, die er am 260803-2110 angenommen hat: `decisions/260804-1122_o_wandern-die-bereichsbreiten-auf-die-links-und-rechts-pfeile.md`. Kein Abnahmekriterium dieses Specs hängt an der Antwort.
