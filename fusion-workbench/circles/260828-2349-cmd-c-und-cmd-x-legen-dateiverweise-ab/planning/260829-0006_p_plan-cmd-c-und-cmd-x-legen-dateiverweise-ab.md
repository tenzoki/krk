...
1. **Die Texte und die Aufzählung der zwei Befehle**
   - Executor: `coder`
...
2. **Die zweite Eingangsform der Zulässigkeitsregel**
   - Executor: `coder`
...
3. **Der zweite Ausgang der Hülle**
   - Executor: `coder`
...
5. **Die zwei Antworten beim Anwendungsdelegierten**
   - Executor: `coder`
...
7. **Die Zählprobe im Betrachter zieht nach**
   - Executor: `coder`
...
9. **Der Abnahmelauf am laufenden Bündel**
