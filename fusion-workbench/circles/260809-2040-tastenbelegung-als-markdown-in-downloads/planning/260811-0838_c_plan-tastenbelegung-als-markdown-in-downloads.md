...
**Bindende Entscheidungsdatensätze:** die sechs `_a_`-Datensätze unter `decisions/` dieses Circles, darunter seit dem 260811-0900 `260811-0838_*_schreibt-krk-einen-pfad-fuer-den-nutzer-je-gekuerzt.md`; dazu aus der Runde 1 `circles/260802-0842-krk-mac-dateimanager-editor-git/decisions/260805-0000_*_menuekuerzel-in-die-konflikterkennung-oder-daneben.md` (ein Kürzel wäre zwingend ein Belegungseintrag), `.../260803-2025_*_wie-zeigt-krk-dem-nutzer-fehler.md` (die Statuszeile mit ihren Rängen) und `.../260802-1134_*_sprache-und-ui-werkzeugkasten.md` (Rust mit AppKit über `objc2`)
