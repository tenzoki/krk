...
**Status:** Complete. Alle 48 Schritte sind gebaut; die Abnahme am laufenden Bündel ist Nutzerarbeit. **Der Zustandsmarker im Dateinamen bleibt bis zum Abschluss der Runde auf offen**, gemeinsam mit dem des Specs: die Runde 1 hat beide erst beim Schließen des Circles auf geschlossen gezogen, und die Zeile `**Active spec/plan:**` im Circle-Datensatz nennt beide beim Namen.
