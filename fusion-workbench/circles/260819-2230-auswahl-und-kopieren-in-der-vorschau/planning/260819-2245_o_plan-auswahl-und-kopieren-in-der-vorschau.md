...
3. [DONE] **Die Textanzeige der Vorschau wird eine eigene Klasse und auswählbar**
   - Executor: `coder`
...
4. [DONE] **Die Anmeldung im Ereignisabgriff: aus einer Fläche werden zwei**
   - Executor: `coder`
...
5. [DONE] **Der Fokus zeigt auf die Textanzeige, und der Quellbezug kommt mit dem Inhalt**
   - Executor: `coder`
   - Files: `crates/krk-ui/src/appkit/vorschau.rs`
...
7. [DONE] **Die eine Abfangstelle: `writeSelectionToPasteboard:types:`**
   - Executor: `coder`
   - Files: `crates/krk-ui/src/appkit/vorschau.rs`
