...
---
Resolved: Als Nachsatz am Spec berichtigt (`planning/260813-2348_o_spec-…`, Punkt 1), nach der Nutzerentscheidung zu `shared/decisions/260906-0203_*`. Die zweite Haelfte des Kriteriums ist auf die Runde zu beziehen: die zwei neuen Kombinationen stehen an keiner anderen Funktion, und `f2` und `cmd+k` waren am 260814 frei. Die eine bestehende Doppelung ist gewollt und im Nachsatz benannt. Nachgezaehlt am 260906 mit `grep -o "tasten = \[[^]]*\]" resources/default-keymap.toml | grep -c "\"cmd+a\""` → 2, also unveraendert gegenueber dem Befund.
