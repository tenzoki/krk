...
---
Resolved: the "Wer sie ruft" paragraph in `crates/krk-core/src/verzeichnis/umfang.rs` is
rewrapped at the file's prevailing 78 characters; the 113-character seam is gone. The only
lines above 100 characters left in the file are a record path and a table row, both single
unbreakable tokens, exactly as this record states.
