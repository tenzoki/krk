...
Implemented: 260824-1849, Commit `abe1a31`, Schritt 6 des Plans. `crates/krk-core/src/leseprofil/bausteine.rs::titelzeile` nimmt die erste nicht leere Zeile und streift führende `#` samt der Leerzeichen dahinter ab; eine leere, nicht lesbare oder nicht als UTF-8 lesbare Datei liefert ihren Dateinamen. Belegt durch `crates/krk-core/tests/leseprofil.rs::die_juengsten_stehen_nach_aenderungsdatum_und_tragen_ihre_titel`, die den Defektdatensatz ohne `#` und die leere Datei einzeln hält.
