...
10. **3.2a Umbauweg, Flächentausch und eine anzeigende Tabelle**
    - Executor: `code-implementer`
...
11. **3.2b Zellenbearbeitung, Anmeldung und die eine Übernahmestelle**
    - Executor: `code-implementer`
...
16. **4.2 Messung: wächst eine mehrzeilige Zelle beim Tippen mit?**
    - Executor: `code-implementer`
