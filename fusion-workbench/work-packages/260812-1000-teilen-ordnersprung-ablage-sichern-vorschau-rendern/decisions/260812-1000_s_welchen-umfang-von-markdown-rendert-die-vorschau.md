...
Implemented:
Deferred:
Superseded by: `circles/260812-1000-teilen-ordnersprung-ablage-sichern-vorschau-rendern/decisions/260812-1851_*_welchen-umfang-von-markdown-rendert-die-vorschau-mit-verschachtelten-listen.md` — nur der Ausschluss verschachtelter Listen ist gefallen, und zwar weil seine Begruendung weggefallen ist: die Einruecktiefe, die die Auszeichnungsmechanik angeblich nicht kennt, hat sie seit `a9e1149`, und sie hat zwei Zeilen gekostet. Tabellen und Bilder bleiben ausgeschlossen, ihre Begruendungen tragen unveraendert. Alles Uebrige dieses Datensatzes gilt fort.
