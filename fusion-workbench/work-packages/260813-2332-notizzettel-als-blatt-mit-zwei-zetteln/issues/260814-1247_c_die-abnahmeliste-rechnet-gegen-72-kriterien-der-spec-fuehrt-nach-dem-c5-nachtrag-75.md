...
---
Resolved: Als Nachsatz am Spec berichtigt (`planning/260813-2348_o_spec-…`, Punkt 4), nach der Nutzerentscheidung zu `shared/decisions/260906-0203_*`, und dabei die vom Befund offengelassene Wahl getroffen. **Die Grundmenge ist 77 und nicht 72 und nicht 75.** Gezaehlt am 260906 mit `grep -c "^- \[ \]"` ueber den Spec → 77; darin die zwei Kriterien unter `## Verhaeltnis zu den zehn Zeitzusagen aus C8 der Runde 1`, die der Spec ausdruecklich zur Abnahme dieser Runde zaehlt. Ohne sie sind es 75, und genau deshalb faellt die Wahl auf 77: der Spec selbst sagt, dass sie dazugehoeren. Die Abnahmeliste `history/260814-1100-abnahmeliste-notizzettel.md` bleibt nach der Ortsregel unangetastet — sie ist die Aufzeichnung eines Standes; die berichtigte Zahl steht am Spec, den der Abnahmelauf abarbeitet, und im `_b_circle.md` dieser Runde stand sie schon.
