...
//!
//! Die sechs sind die einzigen der 74 Funktionen ohne
...
mod tests {
    ...
    /// `gehalten_von = "menue"` fuehrt. Sie tragen als einzige der 74
    ...
    ///
    /// **Sie misst, statt zu naehern.** Fuer 68 der 74 Funktionen ist der
