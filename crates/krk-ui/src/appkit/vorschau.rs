...
//! `:28`); `NSTimeInterval` ist ein `double` (`NSDate.h:14`) und `NSUInteger`
//! ein Ganzzahltyp (`objc/NSObjCRuntime.h:14`); `NSObject` steht seit 10.0
//! (`objc/NSObject.h`); alle uebrigen tragen im SDK keine eigene
